...
```{r}
df<- read_csv("~/Documents/air_polln_metabolomics/analytic_dat/df_for_exposures.csv") |>
  filter(study_id == "CRIB_rita") |>
...
df_exp<- df |>
  ...
  dplyr::select(id, start_date, end_date, lat, long) |>
...
exp_cov_df<- right_join(df_cov, ap_exposures, by = "id") |>
